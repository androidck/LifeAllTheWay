...
public class UserInfo {
     ...
     * false：显示
     */
    private boolean isWhetherShowAds;
    /**
     * 融云tuken
     */
    ...
    public boolean isWhetherShowAds() {
        return isWhetherShowAds;
    }

    public void setWhetherShowAds(boolean whetherShowAds) {
        isWhetherShowAds = whetherShowAds;
    }
    ...
    public String toString() {
        return "UserInfo{" +
                ...
                ", isWhetherShowAds=" + isWhetherShowAds +
                ", token='" + token + '\'' +
                '}';
    }
}
